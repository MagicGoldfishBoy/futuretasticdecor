...
public class ModelDatagen extends ModelProvider {
    ...
    protected void registerSteelModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        ModelDatagenHelpers.createHorizontalRotationModel(blockModels, itemModels, MetalRegistry.STEEL_SHELF.get(), new Variant(modLocation("block/steel_shelf")));

        itemModels.itemModelOutput.accept(
            MetalRegistry.STEEL_SHELF_ITEM.get(),
            ItemModelUtils.plainModel(modLocation("block/steel_shelf"))
        );
    ...
    protected void registerStarMetalModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        ModelDatagenHelpers.createHorizontalRotationModel(blockModels, itemModels, MetalRegistry.STARMETAL_SHELF.get(), new Variant(modLocation("block/starmetal_shelf")));
    ...
    protected void registerLabDecorModels(BlockModelGenerators blockModels, ItemModelGenerators itemModels) {
        ...
        ModelDatagenHelpers.createFurnaceModels(blockModels, itemModels, LaboratoryDecorRegistry.HOLOFURNACE.get(), new Variant(modLocation("block/holofurnace_unlit")), 
        new Variant(modLocation("block/holofurnace_lit")));

        itemModels.itemModelOutput.accept(
            LaboratoryDecorRegistry.HOLOFURNACE_ITEM.get(),
        ...
        ModelDatagenHelpers.createFurnaceModels(blockModels, itemModels, LaboratoryDecorRegistry.HOLOSMELTER.get(), new Variant(modLocation("block/holosmelter_unlit")), 
        new Variant(modLocation("block/holosmelter_lit")));

        itemModels.itemModelOutput.accept(
            LaboratoryDecorRegistry.HOLOSMELTER_ITEM.get(),
            ItemModelUtils.plainModel(modLocation("block/holosmelter_unlit"))
        );
