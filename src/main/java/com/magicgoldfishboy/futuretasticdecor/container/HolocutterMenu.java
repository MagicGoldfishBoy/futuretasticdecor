package com.magicgoldfishboy.futuretasticdecor.container;
...
public class HolocutterMenu extends AbstractContainerMenu {
    ...
    public final Container container = new SimpleContainer(1) {
        ...
        public void setChanged() {
            super.setChanged();
            HolocutterMenu.this.slotsChanged(this);
            HolocutterMenu.this.slotUpdateListener.run();
        }
    };
    /**
    ...
    public HolocutterMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public HolocutterMenu(int containerId, Inventory playerInventory, final ContainerLevelAccess access) {
        ...
        this.resultSlot = this.addSlot(new Slot(this.resultContainer, 1, 143, 33) {
            ...
            public void onTake(Player player, ItemStack stack) {
                ...
                HolocutterMenu.this.resultContainer.awardUsedRecipes(player, this.getRelevantItems());
                player.giveExperiencePoints(5);
                ItemStack itemstack = HolocutterMenu.this.inputSlot.remove(1);
                if (!itemstack.isEmpty()) {
                    HolocutterMenu.this.setupResultSlot(HolocutterMenu.this.selectedRecipeIndex.get());
                }

                access.execute((p_393254_, p_393255_) -> {
                    long i = p_393254_.getGameTime();
                    if (HolocutterMenu.this.lastSoundTime != i) {
                        p_393254_.playSound(null, p_393255_, SoundEvents.UI_STONECUTTER_TAKE_RESULT, SoundSource.BLOCKS, 1.0F, 1.0F);
                        HolocutterMenu.this.lastSoundTime = i;
                    }
                });
            ...
            private List<ItemStack> getRelevantItems() {
                return List.of(HolocutterMenu.this.inputSlot.getItem());
            }
        });
    ...
    public boolean stillValid(Player player) {
        return stillValid(this.access, player, LaboratoryDecorRegistry.HOLOCUTTER.get());
    }
